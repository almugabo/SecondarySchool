...
It tells us how many real solutions (or roots) a quadratic equation has — and the nature of its graph.

#### How the Discriminant Works
1. If $b^2 - 4ac > 0$ → **Two distinct real solutions**.  
   The parabola crosses the x-axis at two points.
2. If $b^2 - 4ac = 0$ → **One real solution** (a repeated root).  
   The parabola just touches the x-axis (the vertex lies on it).
3. If $b^2 - 4ac < 0$ → **No real solutions**.  
   The parabola lies completely above or below the x-axis — it never crosses.

#### Example
Find the discriminant of $4x^2 + 2x + 1 = 0$.
...
✅ Since the discriminant is negative ($-12$), the equation has **no real solutions**.

Graphically, its parabola does **not cross** the x-axis.

---

#### Visual Summary of the Discriminant

| Value of $b^2 - 4ac$ | Number of Real Solutions | Graph Appearance |
|----------------------:|---------------------------|------------------|
| $> 0$ | Two distinct real roots | Parabola crosses x-axis at two points |
| $= 0$ | One real root (double root) | Parabola just touches the x-axis |
| $< 0$ | No real roots | Parabola does not cross the x-axis |

---

### 2.5 Summary: Methods of Solving Quadratic Equations
